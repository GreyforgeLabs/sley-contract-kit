    ...
    `sley-contract-kit` is contract-first. It should consume Sley compiler JSON roots
...
| `sley.project.scaffold.v0` | consumed | current scaffold input |
| `sley.graft.outcome.v0` | consumed | current scaffold input |
| `sley.trace.receipt.v0` | consumed | current scaffold input |
